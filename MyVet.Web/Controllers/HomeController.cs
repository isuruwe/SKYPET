...
namespace MyVet.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(
            ...
            ICombosHelper combosHelper, IHostEnvironment environment)
        {
...
//" as c on c.Id = a.ServiceTypeId where a.id="+id+"";
            string selectQuery = "    SELECT a.[Id]as InvoiceNo,[Description] as Amount,[Date],b.Name as CustomerName,c.Name as Treatment  FROM[SKYPET]. "+
  "  [dbo].[Histories] as a left join[dbo].[Pets] as b on a.PetId = b.Id left join[dbo].[ServiceTypes]  as c on c.Id = "+
 " a.ServiceTypeId where a.hid = (select hid from Histories where  id=" + id + ")";


            DataTable dt = Select(selectQuery);
            using var report = new LocalReport();
            using var rs = Assembly.GetExecutingAssembly().GetManifestResourceStream("MyVet.Web.Reports.Invoice.rdlc");
        ...
        public async Task<IActionResult> MyAgenda()
        {
            var agendas = await _dataContext.Agendas
                ...
                .ThenInclude(o => o.User)
                .Include(a => a.Pet)
                .Where(a => a.Date.Month >= DateTime.Today.Month && a.Date.Day >= DateTime.Today.Day && a.Date.Year >= DateTime.Today.Year).ToListAsync();
